...
class CompletionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          api_extra_body: Extra body parameters for /v1/completions endpoint. This class is used to define
              additional fields that can be included in the request body that are not
    ...
    def create(
        ...
        *,
        ...
        best_of: Optional[int] | Omit = omit,
        echo: Optional[bool] | Omit = omit,
        api_extra_body: Optional[completion_create_params.LlamaCompletionsExtraBodyCerebrasCompletionRequestExtraBody]
        | Omit = omit,
        frequency_penalty: Optional[float] | Omit = omit,
        grammar_root: Optional[str] | Omit = omit,
        logit_bias: Optional[object] | Omit = omit,
        ...
        Args:
          ...
          api_extra_body: Extra body parameters for Llama for /v1/completions.
    ...
    def create(
        ...
        *,
        ...
        | Optional[completion_create_params.LlamaCompletionsExtraBodyCerebrasCompletionRequestExtraBody]
        | Omit = omit,
        frequency_penalty: Optional[float] | Omit = omit,
        grammar_root: Optional[str] | Omit = omit,
        logit_bias: Optional[object] | Omit = omit,
