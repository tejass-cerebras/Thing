...
__all__ = [
    ...
    "CerebrasCompletionsExtraBodyCerebrasCompletionRequest",
    "LlamaCompletionsExtraBodyCerebrasCompletionRequest",
    "LlamaCompletionsExtraBodyCerebrasCompletionRequestExtraBody",
]


class CerebrasCompletionsExtraBodyCerebrasCompletionRequest(TypedDict, total=False):
    model: Required[str]
    ...
    """
    Extra body parameters for /v1/completions endpoint. This class is used to define
...
class LlamaCompletionsExtraBodyCerebrasCompletionRequest(TypedDict, total=False):
    model: Required[str]
    ...
    api_extra_body: Annotated[
        Optional[LlamaCompletionsExtraBodyCerebrasCompletionRequestExtraBody], PropertyInfo(alias="extra_body")
    ]
    """Extra body parameters for Llama for /v1/completions."""
...
class LlamaCompletionsExtraBodyCerebrasCompletionRequestExtraBody(TypedDict, total=False):
    repetition_penalty: Optional[float]


CompletionCreateParams: TypeAlias = Union[
    CerebrasCompletionsExtraBodyCerebrasCompletionRequest, LlamaCompletionsExtraBodyCerebrasCompletionRequest
]
